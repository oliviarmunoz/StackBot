...
# Optional: visualize RGB + depth from each camera
...
for ax, cam in zip(axes, cameras):
    ...
    ax.imshow(depth_img, cmap="magma")
...
# Visualize cropped cup point clouds
...
print("Multi-cup pyramid pick-and-place complete!")
